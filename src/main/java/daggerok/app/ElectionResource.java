...
import daggerok.app.domain.ElectionService;
...
public class ElectionResource {
    ...
    Election beginElection(@RequestBody Map<String, String> request) {
    ...
    Candidate registerCandidate(@PathVariable("electionId") UUID electionId,
    ...
    Voter registerVoter(@PathVariable("electionId") UUID electionId,
                        @RequestBody Map<String, String> request) {
        String name = request.get("name");
